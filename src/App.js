        ...
        >
          <div className="content">
            ...
            <ul>
              ...
              <li>
                <b>I believe in having fun</b> with team building events, volunteer events, and
          ...
          <div className="content">
            ...
            <ul>
              ...
              <li>
                ...
                give me a phone call as I don't always check my messages outside working hours.
              </li>
            </ul>
          </div>
          <div className="image">
          ...
          <div className="content">
            ...
            <ul>
              ...
              <li>
                ...
                discussions, collaborative workshops, and participate in team building events.
              </li>
              <li>
        ...
        <section className="spotlight style1 orient-right content-align-left image-position-center onscroll-image-fade-in">
          <div className="content">
            ...
            <p>
              ...
              email a <b>“question of the bi-week”</b> that will initiate the conversation. I would
              prefer to keep status updates out of our conversation unless you have a pressing need
              for an update. I would strongly encourage you to bring items that you would like to
              discuss with me:
            </p>
            <ul>
            ...
            <p>
              If you have something urgent to discuss with me, don't wait until our one-on-one, feel
              free to reach out to me earlier.
            </p>
          </div>
          <div className="image">
        ...
        <footer className="wrapper style1 align-center">
          <div className="inner social-link-group">
            <ul className="icons">
              ...
              <li>
                <a
                  href="https://linkedin.com/in/ebach"
